...
const Processedto_university = ({
  ...
  const HandleCourierClose = () => setAssignCourierButton(false);
  ...
  // FILTER: role-based + "processed to university but no enrollment no" stage
                      ...
                      StudentData?.documents?.isApproved && (
                        <div className="flex items-center my-2 gap-2">
                          <input
                            ...
                            id=""
                            // future: onChange to handle cancel admission
                          />
                    ...
                    <div className="flex justify-center">
                      {StudentData?.Courier ? (
                        ...
                        <button
                          ...
                          className="text-blue-600 hover:text-blue-700"
                        >
                          <div className="flex justify-center gap-2 px-2.5 py-2 bg-blue-400 rounded-lg font-bold text-white text-xs w-36">
                            Assign Courier
                            <RiEditLine />
                          </div>
                        </button>
...
export default Processedto_university;
