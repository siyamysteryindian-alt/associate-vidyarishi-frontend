...
/* Local skeleton helpers (same style as CenterLayout) */
...
const SubcenterLayout = () => {
  ...
  // Notice fetching (mirrors center layout pattern)
  ...
  const filteredNotices = NoticeListData?.filter(
    (filter) =>
      ...
      (filter?.isPublishToAll || filter?.isPublishToSubCenter)
  );

  const shouldShowBanner =
    (Location.pathname === `/sub-center/dashboard` ||
      Location.pathname === `/sub-center`) &&
    GetUserFromRedux?.role === "sub-center" &&
  ...
  return (
    <Fragment>
      ...
      >
        ...
        >
          ...
          >
            {/* Notice bar (if any) */}
            {GetUserFromRedux?.role === "sub-center" && shouldShowBanner && (
              <div className="mb-6">
                <div
            ...
            <section className="bg-none">
              {Location.pathname === `/sub-center` ? (
                <div className="w-full h-[60vh] flex flex-col items-center justify-center gap-6">
                  <h2 className="text-3xl font-semibold">Welcome Sub Center</h2>
                  <button
                    onClick={() => NavigateTo("/sub-center/dashboard")}
            ...
            <div className="flex items-center justify-between px-6 py-4 border-b">
              <div>
                ...
                <p className="text-xs text-gray-500 mt-1">
                  Select a university to switch context for sub-center actions.
                </p>
              </div>
    ...
    ${
      ...
      {/* bottom footer bar for sub-center (fixed) */}
      <div></div>
    </Fragment>
  );
};

export default SubcenterLayout;
