...
const CreateEmailTemplate = ({ HandleCloseCreateEmailTemplate }) => {
  ...
  // useEffect(() => {
  //   // Add placeholders only once, not repeatedly
  //   if (selectedItems.length > 0) {
  //     const placeholders = selectedItems.map((item) => `{{${item}}}`).join(" ");
      ...
      <div className="flex justify-center items-center mt-10">
        <div className="bg-white dark:bg-slate-900 dark:text-white rounded-xl h-[80vh] w-[90vh] overflow-y-scroll ScrollBarStyle2 ">
          <div className=" flex justify-between items-center flex-row p-4 border-b-2 border-b-slate-400">
            <div className="text-base font-semibold">Create Email Template</div>
            <button onClick={HandleCloseCreateEmailTemplate}>
              <IoClose
                size={28}
                    ...
                    <>
                      <div className="relative w-full ">
                        {/* <input
                          ...
                          className="w-full px-3 py-2 border-b outline-none focus:border-purple-500"
                          placeholder="Search..."
                        /> */}
                        <div
