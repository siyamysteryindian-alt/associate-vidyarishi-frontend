...
const UpdateDocuments = () => {
  const { UpdateAllDocuments, setUpdateAllDocuments } =
  ...
  const HandleUploadOtherMultiplePhoto = async (e) => {
    try {
      ...
      if (urls.length > 0) {
        setUpdateAllDocuments((prev) => ({
          ...prev,
          MoreOtherPhoto: [...(prev.MoreOtherPhoto || []), ...urls],
        }));
  ...
  useEffect(() => {
    console.log("UpdateAllDocuments - ", UpdateAllDocuments);
  }, [UpdateAllDocuments]);

  // --- Shared UI classes (aligned with create Documents UI) ---
        ...
        <div className="px-4 py-3 border-b border-slate-200 dark:border-slate-700 flex items-center justify-between">
          <div>
            ...
            <p className="text-[10px] text-slate-400 dark:text-slate-500 mt-0.5">
              Replace or add updated KYC & supporting documents
            </p>
          </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-3">
              ...
              <div>
                ...
                <input
                  ...
                  required
                />
                {renderPreview(UpdateAllDocuments?.photo)}
              </div>
              ...
              <div>
                ...
                <input
                  ...
                  required
                />
                {renderPreview(UpdateAllDocuments?.aadhaar)}
              </div>

              {/* Aadhaar Back */}
              <div>
                <label htmlFor="AadhaarBack" className={fileLabelClass}>
                ...
                <input
                  ...
                  required
                />
                {renderPreview(UpdateAllDocuments?.aadharBack)}
              </div>
              ...
              <div>
                ...
                <input
                  ...
                  required
                />
                {renderPreview(UpdateAllDocuments?.StudentSignature)}
              </div>
            </div>
          </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
              ...
              <div>
                ...
                <input
                  ...
                  className={fileInputClass}
                />
                {renderPreview(UpdateAllDocuments?.ABCID)}
              </div>
              ...
              <div>
                ...
                <input
                  ...
                  className={fileInputClass}
                />
                {renderPreview(UpdateAllDocuments?.DEBID)}
              </div>
            </div>
          </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-3">
              ...
              <div>
                ...
                <input
                  ...
                  className={fileInputClass}
                />
                {renderPreview(UpdateAllDocuments?.ParentSignature)}
              </div>
              ...
              <div>
                ...
                <input
                  ...
                  className={fileInputClass}
                />
                {renderPreview(UpdateAllDocuments?.Migration)}
              </div>
              ...
              <div>
                ...
                <input
                  ...
                  className={fileInputClass}
                />
                {renderPreview(UpdateAllDocuments?.Aafidavit)}
              </div>

              {/* Other Certificates (multiple) */}
              <div>
                <label htmlFor="MoreOtherPhoto" className={fileLabelClass}>
                  Other Certificates (multiple)
                </label>
                <input
                  id="MoreOtherPhoto"
                ...
                {UpdateAllDocuments?.MoreOtherPhoto?.length > 0 && (
                  <div className="w-full mt-2 grid grid-cols-3 gap-2">
                    {UpdateAllDocuments.MoreOtherPhoto.map((photoUrl, idx) => (
