...
const OperationalLayout = () => {
  ...
  // fetching notices (logic preserved)
  ...
  const shouldShowBanner =
    Location.pathname === `/operational/dashboard` &&
    GetFromReduxUser?.role === "operation-manager" &&
            ...
            <section className="bg-none">
              {Location.pathname === `/operational` ? (
                <div className="w-full h-[60vh] flex flex-col items-center justify-center gap-6">
                  ...
                  <button
                    onClick={() => NavigateTo("/operational/dashboard")}
            ...
            <div className="flex items-center justify-between px-6 py-4 border-b">
              <div>
                ...
                <p className="text-xs text-gray-500 mt-1">
                  Select a university to switch context for operational actions.
                </p>
              </div>
